...
{{--            <svg class="relative left-[calc(50%-11rem)] -z-10 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-70rem)] sm:h-[88.375rem]" viewBox="0 0 1155 678">--}}
...
{{--            <svg class="relative left-[calc(50%-11rem)] -z-10 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%+50rem)] sm:h-[42.375rem]" viewBox="0 0 1155 678">--}}
{{--                <path fill="url(#f4773080-2a16-4ab4-9fd7-579fec69a4f7)" fill-opacity=".2" d="M317.219 518.975L203.852 678 0 438.341l317.219 80.634 204.172-286.402c1.307 132.337 45.083 346.658 209.733 145.248C936.936 126.058 882.053-94.234 1031.02 41.331c119.18 108.451 130.68 295.337 121.53 375.223L855 299l21.173 362.054-558.954-142.079z" />--}}
{{--                <defs>--}}
{{--                    <linearGradient id="f4773080-2a16-4ab4-9fd7-579fec69a4f7" x1="1155.49" x2="-78.208" y1=".177" y2="474.645" gradientUnits="userSpaceOnUse">--}}
{{--                        <stop stop-color="#9089FC"></stop>--}}
        ...
        <main class="overflow-hidden relative h-full">
            <div class="pt-0">
                <div class="mx-auto h-full">
                    {{--                    <img style="max-width: 130rem;" class="mt-5 lg:mt-16 rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 mx-auto" src="{{asset('/images/temple2.jpg')}}" alt="App screenshot" width="2432" height="1442">--}}
                    {{----}}
                    ...
                    <div id="image-wrap" class="opacity-70 shadow mx-auto rounded h-[calc(100vh - 3vw)]" style="
                        height:87vh;
                        max-width: 100%;
                    ...
                    {{--                    <img style="" class="mx-auto w-full" src="/images/temple3.jpg" >--}}
                </div>
            </div>
        </main>
    </div>
            ...
            <div id="mobile-one"   onclick="videoListClick()"
                ...
                <div class="fixed inset-0 z-40 flex">
                    <div onclick="videoListClick()" id="mobile-two"
                         class="video-list-wrap -translate-x-full transition ease-in-out duration-300 transform relative flex w-full flex-1 flex-col mvs-pt-3" style="background: #fff;">
                        ...
                        <div class="rounded-full flex block mvs-pb-3 mvs-px-3">
                            ...
                            <input id="tel" name="id" type="number"
                                   ...
                                   class="block w-full appearance-none rounded-md border border-gray-300 px-3 mvs-py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"/>
                            <div onclick="telRetrieve()" class="mvs-px-2 bg-green-400 mvs-ml-5 rounded-full cursor-pointer hover:bg-indigo-500">
                                <svg class="mvs-svg rounded flex justify-center items-center mvs-w-7 mvs-h-10 text-white align-middle" fill="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                </svg>
                            </div>
                            <div onclick="telRetrieveDemo()" class="mvs-px-2 bg-gray-700 mvs-ml-5 rounded-full cursor-pointer hover:bg-indigo-500">
                                <svg class="mvs-svg rounded flex justify-center items-center mvs-w-7 mvs-h-10 text-white align-middle" fill="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" />
                                </svg>
                            </div>
                        </div>
                        <div class="flex flex-shrink-0 items-center mvs-px-4 border-t mvs-pt-3">
                            <div id="customerName" class="text-gray-500 mvs-text-lg font-semibold">

                            </div>
                        </div>
                        <div class="h-0 flex-1 overflow-y-auto">
                            <nav id="videoList" class="mvs-px-4 grid grid-cols-3">
                            </nav>
                        </div>
                    </div>
    ...
    <script>
        ...
        function singlePlay(data) {
            ...
            videos.forEach((video,index) => {
                const item = `<div onclick="videoSelect(${index})" class="col-span-1 video-item hover:bg-gray-100 relative border-b mvs-pb-2 mvs-pt-2"><div class="relative group flex items-center mvs-text-base leading-5 font-medium rounded-md"><img class="mvs-thumbnail object-cover rounded w-screen" src="${video.thumbnail_url}" alt=""><div class="text-white text-center mvs-text-8xl font-semibold flex items-center justify-center w-full h-full absolute top-0 left-0 bg-gray-900"  style="background: rgba(0, 0, 0, 0.3);">${index+1}
</div></div><div class="text-gray-700 flex justify-between font-semibold pl-1 pr-3"><div class="mvs-text-lg mvs-mt-1">${video.title}</div><div class="mvs-text-lg">${video.playtime_string}</div></div><div class="text-gray-500 flex pl-1"><div class="mvs-text-base">${video.deceased}</div><div class="mvs-text-base">(${video.birth} ~ ${video.death})</div></div></div>`;
        ...
        function multiPlay(data) {
            ...
            videos.forEach((video,index) => {
                const item = `<div onclick="videoSelect(${index})" class="col-span-1 video-item hover:bg-gray-100 relative border-b mvs-pb-2 mvs-pt-2"><div class="relative group flex items-center mvs-text-base leading-5 font-medium rounded-md"><img class="mvs-thumbnail object-cover rounded w-screen" src="${video.thumbnail_url}" alt=""><div class="text-white text-center mvs-text-8xl font-semibold flex items-center justify-center w-full h-full absolute top-0 left-0 bg-gray-900"  style="background: rgba(0, 0, 0, 0.3);">${index+1}
</div></div><div class="text-gray-700 flex justify-between font-semibold pl-1 pr-3"><div class="mvs-text-lg mvs-mt-1">${video.title == null ? '': video.title }</div><div class="mvs-text-lg">${video.playtime_string == null ? '': video.playtime_string }</div></div><div class="text-gray-500 flex pl-1"><div class="mvs-text-base">${video.deceased == null ? '': video.deceased }</div><div class="mvs-text-base">${video.birth == null ? '': '('+video.birth}  ${video.death == null ? '': ' ~ '+video.death+')'}</div></div></div>`;
                videoList.insertAdjacentHTML('beforeend', item);
            })
            customerName.innerHTML = customer.name;
