<div class="inline-block pc-header">
    <div class="h-screen">
        <div class="h-full hidden lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
            <div class="flex items-center justify-between gap-x-6 bg-yellow-400 px-4 py-2.5 sm:pr-3.5 lg:pl-8">
                <p class="text-lg leading-6 text-gray-600">
                    <a href="#">
                        <strong class="">{{env('APP_PLACE')}}</strong>
                    </a>
                </p>
            </div>
            <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
                <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
                    <a href="/dashboard" class="flex flex-shrink-0 items-center px-4">
                    ...
                    <nav class="mt-5 flex-1 bg-gray-800" aria-label="Sidebar">
                        ...
                        <a href="{{route('playback-management.index')}}"
                           class="@php echo $route == 'playback-management'? 'border-indigo-600  border-l-8 bg-gray-900 text-white' : 'text-gray-300 pl-4' @endphp
                               hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium">
                            <svg class="
                             @php echo $route == 'playback-management'? 'text-white' : 'text-gray-400' @endphp
                             mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M6 20.25h12m-7.5-3v3m3-3v3m-10.125-3h17.25c.621 0 1.125-.504 1.125-1.125V4.875c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125z" />
                            </svg>
                            <span class="flex-1">추모영상 재생관리</span>
                        </a>
