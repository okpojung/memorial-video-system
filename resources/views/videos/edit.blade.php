            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">영상 수정</h1>
                    </div>
                </div>
                <form id="form" method="POST" action="/videos/{{$video->id}}" class="">
                    @method('patch')
                    @csrf
...
{{--                        </div>--}}
                        <div
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <input type="text" required maxlength="30" name="title" id="title"
                                       placeholder="제목을 입력하세요" value="@isset($video->title) {{$video->title}} @endisset"
                        ...
                        <div
                            class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 pt-2 sm:pt-5">
                            <label for="video_tel" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">전화번호
                            </label>
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <input type="text" maxlength="50" name="video_tel" id="video_tel"
                                       placeholder="전화번호를 입력하세요" value="@isset($video->video_tel) {{$video->video_tel}} @endisset"
                        ...
                        <div
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <input type="text" maxlength="50" name="deceased" id="deceased" placeholder="고인명을 입력하세요" value="@isset($video->deceased) {{$video->deceased}} @endisset"
                                       class="placeholder-gray-400 block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-sm sm:text-sm">
                            </div>
                        </div>
                        <div
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <input type="text" maxlength="50" name="birth" id="birth" placeholder="출생일을 입력하세요" value="@isset($video->birth) {{$video->birth}} @endisset"
                                       class="placeholder-gray-400 block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-sm sm:text-sm">
                            </div>
                        </div>
                        <div
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <input type="text" maxlength="50" name="death" id="death" placeholder="사망일을 입력하세요" value="@isset($video->death) {{$video->death}} @endisset"
                                       class="placeholder-gray-400 block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-sm sm:text-sm">
                            </div>
                        </div>
                    </div>
